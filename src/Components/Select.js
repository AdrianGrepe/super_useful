...
const Select = ({onSelected=s=>s, defaultValue, style={},selectedOption,disabled = false,options, className, ...props}) => {
    ...
    return (
        <>
            <div  className={className} {...props}>
                <div style={{cursor : selectedOption !== 'Marca' ? 'not-allowed': 'pointer'}} className={classes.dropDownHeader} onClick={selectedOption === 'Marca' ? toggling : null}>
