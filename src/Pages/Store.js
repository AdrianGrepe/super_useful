...
export default function Store() {
    ...
    const [selectedCarLink4, setSelectedCarLink4] = useState(null)
    const [selectedCarLink5, setSelectedCarLink5] = useState(null)
    const [selectedCarLink6, setSelectedCarLink6] = useState(null)
